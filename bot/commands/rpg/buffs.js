...
/**
 * Command to show active magical effects.
 * @extends BaseCommand
 */
class BuffsCommand extends BaseCommand {
    constructor() {
        super({
            name: "buffs",
            description: "Muestra tus efectos mágicos y pociones activas y su tiempo restante."
        });
    }
...
export default new BuffsCommand();