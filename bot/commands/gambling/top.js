...
/**
 * Command to display the gambling leaderboard.
 * @extends BaseCommand
 */
class TopGamblingCommand extends BaseCommand {
    constructor() {
        super({
            name: "top",
            description: "Muestra el ranking de los ludópatas más exitosos del casino."
        });
    }
...
export default new TopGamblingCommand();